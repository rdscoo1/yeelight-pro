...
async def async_get_config_entry_diagnostics(
    ...
    if gtw:
        ...
        diagnostics_data["gateway"] = {
            ...
            "stopping": gtw.stopping,
            "reconnect_delay": gtw.reconnect_delay,
            "json_error_count": gtw.json_error_count,
            "keepalive_interval": gtw.keepalive,
            "pending_messages": gtw.pending_message_count,
            "devices_count": gtw.device_count,
            "last_topology_devices": list(gtw.last_topology_device_ids),
